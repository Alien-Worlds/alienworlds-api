...
export default class Config {
  constructor(
    ...
    public readonly processorThreads: number = Number(process.env.PROCESSOR_THREADS),
    public readonly blockrangeThreads: number = Number(process.env.BLOCKRANGE_THREADS),
