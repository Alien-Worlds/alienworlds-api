...
import { CompleteBlockRangeScanUseCase } from 'block-range/domain/use-cases/complete-block-range-scan.use-case';
...
import { BlockRangeProcess } from 'block-range/domain/block-range.process';
