...
describe('GetNftsQueryModel Unit tests', () => {
  it('"GetNftsQueryModel.create" should create query model', async () => {
    const model = GetNftsQueryModel.create(GetNftsInput.fromDto(dto));
  ...
  it('"GetNftsQueryModel.create" should create query model with proper sorting value', async () => {
    dto.sort = 'desc';
    const model = GetNftsQueryModel.create(GetNftsInput.fromDto(dto));
  ...
  it('"toQueryParams" should handle global_sequence data based on input', async () => {
    ...
    let model = GetNftsQueryModel.create(GetNftsInput.fromDto(dto));

    expect(model.toQueryParams().filter.global_sequence).toBeUndefined();

    dto.global_sequence_from = 1;
    dto.global_sequence_to = 10;
    model = GetNftsQueryModel.create(GetNftsInput.fromDto(dto));
