...
describe('GetNftsInput Unit tests', () => {
  it('"GetNftsInput.fromDto" should create controller input data based on user data', async () => {
    const input = GetNftsInput.fromDto(dto);
