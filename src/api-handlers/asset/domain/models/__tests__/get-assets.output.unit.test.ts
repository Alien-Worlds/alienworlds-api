...
import { GetAssetsOutput } from '../get-assets.output';
...
describe('GetAssetsOutput Unit tests', () => {
  it('GetAssetsOutput.fromRequest should create input with default values when none were given', async () => {
    const output = GetAssetsOutput.fromEntities([
