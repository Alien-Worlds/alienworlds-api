...
import { GetMinesOutput } from '../get-mines.output';
...
describe('GetMinesOutput Unit tests', () => {
  it('"GetMinesOutput.fromEntities" should create output based on entities', async () => {
    const output = GetMinesOutput.fromEntities([Mine.fromDto(mineDocument)]);
