...
describe('GetMinesInput Unit tests', () => {
  it('"GetMinesInput.fromRequest" should create controller input data based on user data', async () => {
    const input = GetMinesInput.fromRequest(dto);
