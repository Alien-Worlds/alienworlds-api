...
import { GetMinesQueryModel } from '../get-mines.query-model';
...
describe('GetMinesQueryModel Unit tests', () => {
  it('"GetMinesQueryModel.toQueryParams" should create mongodb query model', async () => {
    const model = GetMinesQueryModel.create(
      GetMinesInput.fromRequest(requestData)
    );
  ...
  it('"GetMinesQueryModel.toQueryParams" should handle global_sequence data based on input', async () => {
    requestData.global_sequence_from = null;
    requestData.global_sequence_to = null;
    let model = GetMinesQueryModel.create(
      GetMinesInput.fromRequest(requestData)
    );
    ...
    model = GetMinesQueryModel.create(GetMinesInput.fromRequest(requestData));
  ...
  it('"GetMinesQueryModel.toQueryParams" should handle block_timestamp data based on input', async () => {
    requestData.to = null;
